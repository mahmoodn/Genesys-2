...
create_clock -period 5.000 -name sys_clk_pin [get_ports sysclk_p]

## Buttons
set_property -dict { PACKAGE_PIN E18   IOSTANDARD LVCMOS33 } [get_ports { reset }]; #IO_0_14 Sch=cpu_resetn
...
## LEDs
set_property -dict { PACKAGE_PIN T28   IOSTANDARD LVCMOS33 } [get_ports { led }]; #IO_L11N_T1_SRCC_14 Sch=led[0]
